/**
 * Capture v0.8 RC verification into verification/v0.8/
 */
...
const outDir = path.join(root, 'verification', 'v0.8')
...
const report = {
  ...
  node: process.version,
  story:
    'Fingerprint-bound historical propositions + atomic merge import + CalendarDay contract + RC polish',
}
