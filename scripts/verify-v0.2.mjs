/**
 * Capture v0.2 verification command output into verification/v0.2/
 */
...
const outDir = path.join(root, 'verification', 'v0.2')
...
const report = {
  ...
  failedSteps: failed,
  story:
    'Decision capture → commit → later revision → review/memory drift → predictions/assumptions → calibration patterns',
}
